    ...
    public class IO
    {
        ...
        public static int GetConsoleInt(string prompt, int min, int max)
        {
            ...
            do
            {
                ...
                if (validInt)
                {
                    //When recieving an out of range answer, instead of asking them for their answer again I opted to just clamp it to the min/max
        ...
        //Get console menu, but with fun colors from the mastermind lab
